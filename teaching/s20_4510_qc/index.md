...
## About
*  **Syllabus**:
   [PDF]({{ site.url }}/teaching/s20_4510_qc/s20_qc_syllabus_update.pdf){:target="_blank"}. More admin. info. can be found on [FAQs]({{ site.url }}/teaching/s20_4510_qc/admin/). 
...
*  **Text**: No required text. We will primarily follow online lecture
   ...
   access available via PSU library). The [Resource page]({{ site.url }}/teaching/s20_4510_qc/resource/) contains additional
   useful materials.
