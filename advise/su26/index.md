...
*   **Useful Contacts**
	...
	*  PSU [Campus Public Safety](https://www.pdx.edu/cpso/campus-public-safety): 633 SW Montgomery Street. Emergency: **503-725-5911**; Non-Emergency: **503-725-4407**

## Resources
*  **Goals**: 1) understand basics of quantum information, quantum circuits, and
   important quantum algorithms (e.g., phase estimation and Grover.) 2) learn
   quantum programming with QISKIT, and implement selected quantum algorithms. 3)
   optimize the circuit implementations, possibly with the aid of AI. 
*  John Watrous's [lectures on QC](https://jhwatrous.github.io/books-and-courses.html): *Understanding Quantum Information and Computation*. 
    - Module 1 [Basics of quantum information](https://quantum.cloud.ibm.com/learning/en/courses/basics-of-quantum-information)
    - Module 2 [Fundamentals of quantum algorithms](https://quantum.cloud.ibm.com/learning/en/courses/fundamentals-of-quantum-algorithms)
*  QISKIT [tutorials](https://www.youtube.com/playlist?list=PLOFEBzvs-Vvo4oV-fMl1EAuZmJhI5qA_i)
